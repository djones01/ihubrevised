        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromBatchFiles = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    NumSourceApis = table.Column<int>(nullable: false),
                    NumSourceFiles = table.Column<int>(nullable: false),
                    TotalSourceCount = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ObjectTargetId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CheckTypes = table.Column<bool>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    EvalConditions = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    NumSourceApis = table.Column<int>(nullable: false),
                    NumSourceFiles = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataObjectFormats", x => new { x.DataObjectId, x.ObjectFormatId });
                    table.ForeignKey(
                        name: "FK_DataObjectFormats_DataObjects_DataObjectId",
                        column: x => x.DataObjectId,
                        principalTable: "DataObjects",
                        principalColumn: "DataObjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataObjectFormats_ObjectFormats_ObjectFormatId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApiInfo", x => x.ApiInfoId);
                    table.ForeignKey(
                        name: "FK_ApiInfo_ObjectFormats_ObjectFormatId",
                        column: x => x.ObjectFormatId,
                        principalTable: "ObjectFormats",
                        principalColumn: "ObjectFormatId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataObjectTargets", x => new { x.DataObjectId, x.ObjectTargetId });
                    table.ForeignKey(
                        name: "FK_DataObjectTargets_DataObjects_DataObjectId",
                        column: x => x.DataObjectId,
                        principalTable: "DataObjects",
                        principalColumn: "DataObjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataObjectTargets_ObjectTargets_ObjectTargetId",
                        column: x => x.ObjectTargetId,
                        principalTable: "ObjectTargets",
                        principalColumn: "ObjectTargetId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FileInfoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Active = table.Column<bool>(nullable: false),
                    BatchProcessLines = table.Column<bool>(nullable: false),
                    CompressFile = table.Column<bool>(nullable: false),
                    Created_By = table.Column<string>(nullable: true),
                    Creation_Date = table.Column<DateTime>(nullable: true),
                    Date_Modified = table.Column<DateTime>(nullable: true),
                    ...
                    FileSizeLimitUnits = table.Column<string>(nullable: true),
                    FileType = table.Column<string>(nullable: true),
                    Hidden = table.Column<bool>(nullable: false),
                    Modified_By = table.Column<string>(nullable: true),
                    ObjectFormatId = table.Column<int>(nullable: false),
                    ObjectTargetId = table.Column<int>(nullable: false),
                    RowLimit = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileInfo_ObjectFormats_ObjectFormatId",
                        column: x => x.ObjectFormatId,
                        principalTable: "ObjectFormats",
                        principalColumn: "ObjectFormatId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "FixedLengthLines",
                columns: table => new
                {
                    FixedLengthLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    FieldIndexes = table.Column<string>(nullable: true),
                    FileInfoId = table.Column<int>(nullable: true),
                    LineIndex = table.Column<int>(nullable: false),
                    LineLength = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FixedLengthLines", x => x.FixedLengthLineId);
                    table.ForeignKey(
                        name: "FK_FixedLengthLines_FileInfo_FileInfoId",
                        column: x => x.FileInfoId,
                        principalTable: "FileInfo",
                        principalColumn: "FileInfoId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiInfo_ObjectFormatId",
                table: "ApiInfo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataObjectFormats_ObjectFormatId",
                table: "DataObjectFormats",
                column: "ObjectFormatId");

            migrationBuilder.CreateIndex(
                name: "IX_DataObjectTargets_ObjectTargetId",
                table: "DataObjectTargets",
                column: "ObjectTargetId");

            migrationBuilder.CreateIndex(
                name: "IX_FileInfo_ObjectFormatId",
                table: "FileInfo",
                column: "ObjectFormatId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FixedLengthLines_FileInfoId",
                table: "FixedLengthLines",
                column: "FileInfoId");
